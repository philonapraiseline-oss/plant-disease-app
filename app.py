...
MODEL_URL = (
    "https://huggingface.co/philona777/"
    "plant-disease-model/resolve/main/"
...
qa_database = {
    ...
    "yellow": (
        ...
        "watering problems, nutrient issues, pests or disease. "
        "Check the soil moisture and inspect both sides of the leaves."
    ),

    "water": (
        "Water plants according to their needs and growing conditions. "
        "Avoid constantly waterlogged soil and avoid unnecessarily "
        "wetting the leaves."
    ),

    "tomato": (
        "Tomatoes generally need good sunlight, consistent watering, "
        "airflow and regular inspection for pests and diseases."
    ),

    "potato": (
        "Potatoes should be monitored for early blight and late blight. "
        "Good airflow, appropriate watering and healthy planting "
        "material can help."
    ),

    "pepper": (
        "Peppers benefit from sunlight, appropriate watering, "
        "healthy soil and adequate spacing."
    ),

    "blight": (
        "For blight problems, remove severely affected material, "
        "reduce prolonged leaf wetness and improve airflow."
    ),

    "spots": (
        "Leaf spots can have several causes including fungi, "
        "bacteria, pests or environmental stress."
    ),

    "healthy": (
        "Healthy plants generally have strong growth and leaves "
        "without significant discoloration, lesions or pest damage."
    ),

    "fungus": (
        "Fungal diseases are often encouraged by moisture and poor "
        "airflow. Good spacing and ventilation can reduce risk."
    ),

    "pest": (
        "Inspect both sides of leaves for insects, eggs, webbing "
        "or feeding damage. Early detection is important."
    )
}
...
# =========================================================
    ...
    if uploaded_file:
        ...
        if analyze:
            ...
            with st.spinner(
                "🤖 PlantCare AI is analyzing the leaf..."
            ):
        ...
        if question.strip():
            ...
            if answer is None:
                ...
                answer = (
                    ...
                    "tomato, potato and pepper plants, "
                    "common diseases, symptoms, watering, "
...
# =========================================================
    ...
    <div class="hero">
        ...
        <div class="hero-text">
            PlantCare AI uses a TensorFlow/Keras image
            classification model to recognize visual
            patterns in plant leaves.
        </div>
